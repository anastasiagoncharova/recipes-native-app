...
export default function SearchScreen(props) {
  ...
  const handleSearch = (text) => {
    setValue(text);
    var recipeArray1 = getRecipesByRecipeName(text, recipes);
    var recipeArray2 = getRecipesByCategoryName(text, recipes);
    var recipeArray3 = getRecipesByIngredientName(text, recipes);
